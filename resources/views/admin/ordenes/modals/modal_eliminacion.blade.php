...
<div class="modal modal-danger fade" id="modal-danger-caracteristica" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <p>¿Estas seguro de borrar la caracteristica de producto de la orden #OC: {{ $orden->identificador }}?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Cancelar</button>
                <a id="deleteCaracteristica" role="button" class="btn btn-outline"><i class="fa fa-trash"></i> Borrar</a>
            </div>
        </div>
    </div>
</div>
<div class="modal modal-danger fade" id="modal-danger-clasificacion" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <p>¿Estas seguro de borrar la clasificación de producto de la orden #OC: {{ $orden->identificador }}?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Cancelar</button>
                <a id="deleteClasificacion" role="button" class="btn btn-outline"><i class="fa fa-trash"></i> Borrar</a>
            </div>
        </div>
    </div>
</div>
<div class="modal modal-danger fade" id="modal-danger-diseno" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <p>¿Estas seguro de borrar el diseño de producto de la orden #OC: {{ $orden->identificador }}?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Cancelar</button>
                <a id="deleteDiseno" role="button" class="btn btn-outline"><i class="fa fa-trash"></i> Borrar</a>
            </div>
        </div>
    </div>
</div>