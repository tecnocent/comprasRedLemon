                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-1">
                            <label for="">&nbsp;</label>
                            <button type="button" class="form-control btn btn-block btn-default pull-right col-sm-2" data-toggle="modal" data-target="#nuevo-producto-guarda-modal" id="nuevo_proveedor"><i class="fa fa-pencil-square-o"></i> </button>
                        </div>
...
<div class="modal right1 fade" id="seguimiento-producto-modal" tabindex="-1" role="dialog" aria-labelledby="pagos">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <!-- Formulario -->
            <form action="{{ route('seguimiento.save', ['id'=> $orden->id]) }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal right1 fade" id="caracteristica-producto-modal" tabindex="-1" role="dialog" aria-labelledby="pagos">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <!-- Formulario -->
            <form action="{{ route('caracteristica.save', ['id'=> $orden->id]) }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 line">
                                    <div class="form-group">
                                        ...
                                        <textarea required class="form-control" placeholder="Ingresa las especificaciones" rows="3" name="especificacion_producto"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 line">
                                    <div class="form-group">
                                        <label>Especificaciones electricas</label>
                                        <textarea required class="form-control" placeholder="Ingresa las especificaciones electricas" rows="3" name="especificaion_electrica"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 line">
                                    <div class="form-group">
                                        <label>Link amazon</label>
                                        <input type="url" name="link_amazon" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6 line">
                                    <div class="form-group">
                                        <label>Link alibaba</label>
                                        <input type="url" name="link_alibaba" class="form-control">
                                    </div>
                                </div>
                                <!-- /.col -->
                            </div>
...
<div class="modal right1 fade" id="nuevo-producto-guarda-modal" tabindex="-1" role="dialog" aria-labelledby="">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <!-- Formulario -->
            <form id="nuevo-producto-guarda-form" method="post">
                {{ csrf_field() }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal right1 fade" id="nuevo-diseno-producto" tabindex="-1" role="dialog" aria-labelledby="pagos">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <!-- Formulario -->
            <form action="{{ route('diseno.save' , ['id' => $orden->id]) }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel2">Nueva Diseño</h4>
                </div>
                <div class="modal-body">
                    <div class="">
                        <!-- /.box-header -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 line">
                                    <div class="form-group">
                                        ...
                                        <label class="checkbox-inline checbox-switch switch-primary"> <input type="checkbox" name="oem"/> <span></span></label>
                                    </div>
                                </div>
                                <div class="col-md-4 line">
                                    <div class="form-group">
                                        <label>¿Empaque?</label><br>
                                        <label class="checkbox-inline checbox-switch switch-primary"> <input type="checkbox" name="empaque"/> <span></span></label>
                                    </div>
                                </div>
                                <div class="col-md-4 line">
                                    <div class="form-group">
                                        <label>¿Instructivo?</label><br>
                                        <label class="checkbox-inline checbox-switch switch-primary"> <input type="checkbox" name="instructivo"/> <span></span></label>
                                    </div>
                                </div>
                                <div class="col-md-6 line">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 line">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control datepicker" name="fecha_autorizacion_trafico">
                                    </div>
                                </div>
                                <div class="col-md-6 line">
                                    <div class="form-group">
